...
public enum UpgradeProps {
      special_effects(3, "Buy Special Effects", new Integer[]{30, 200, 500, Integer.MAX_VALUE}
    ...
    , pegs(3, "Buy Pegs", new Integer[]{2, 10, 500, 1000, Integer.MAX_VALUE}
    ...
    , bumpers(3, "Buy Bumpers", new Integer[]{2, 20, 600, 1400, Integer.MAX_VALUE}
    ...
    , spinners_left(3, "Buy Left Spinner", new Integer[]{30, 300, 1000, 10000, Integer.MAX_VALUE}
    ...
    , spinners_right(3, "Buy Right Spinner", new Integer[]{30, 300, 1000, 10000, Integer.MAX_VALUE}
    ...
    , cash_multipliers(4,"Buy Cash Multiplier", new Integer[]{60, 600, 1800, 10000, Integer.MAX_VALUE}
    ...
    , ball_multipliers(5, "Buy More Balls", new Integer[]{20, 100, 1000, 3000, 10000, Integer.MAX_VALUE}
    ...
    , audio_packs(2, "Buy Audio", new Integer[]{100, 1000, Integer.MAX_VALUE}
    ...
    , art_packs(4, "Buy Art Packs", new Integer[]{40, 400, 4000, Integer.MAX_VALUE}
    ...
    , win_game(1, "Win the game", new Integer[]{0, 30000}
