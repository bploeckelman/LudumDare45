...
public enum UpgradeProps {
      special_effects(3, "Buy Special Effects", new Integer[]{10, 50, 250, Integer.MAX_VALUE}
    ...
    , bumpers(3, "Buy Bumpers", new Integer[]{2, 20, 200, 1400, Integer.MAX_VALUE}
    ...
    , spinners_left(3, "Buy Left Spinner", new Integer[]{20, 300, 1000, 10000, Integer.MAX_VALUE}
    ...
    , spinners_right(3, "Buy Right Spinner", new Integer[]{20, 300, 1000, 10000, Integer.MAX_VALUE}
    ...
    , cash_multipliers(4,"Buy Cash Multiplier", new Integer[]{20, 200, 2000, 10000, Integer.MAX_VALUE}
    ...
    , audio_packs(2, "Buy Audio", new Integer[]{80, 500, Integer.MAX_VALUE}
