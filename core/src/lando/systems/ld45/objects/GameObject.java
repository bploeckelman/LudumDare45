...
public abstract class GameObject {
    ...
    public void renderEditModeRadius(SpriteBatch batch) {
        ...
        batch.draw(screen.assets.assetMap.get(screen.game.player.artPack).get(AssetType.part_boundary).getKeyFrame(artAccum), placementBounds.x - placementBounds.radius, placementBounds.y - placementBounds.radius, placementBounds.radius*2f, placementBounds.radius*2f);
